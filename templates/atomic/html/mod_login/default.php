...
<?php if ($params->get('greeting')) : ?>
	...
	<?php if(1 != $game_log['ret']) : ?>
        <li><?php echo $game_log['msg']; ?></li></div>
    <?php else : ?>
	...
	<div id="form-login-username" class="control-group">
		...
		<?php if (!$params->get('usetext')) : ?>
			<div class="input-prepend">
				...
				账号：<input id="modlgn-username" type="text" name="username" class="input" tabindex="0" size="18" placeholder="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?>" />
			</div>
		<?php else: ?>
	...
	<div id="form-login-password" class="control-group">
		...
		<?php if (!$params->get('usetext')) : ?>
			<div class="input-prepend">
				...
				密码：<input id="modlgn-passwd" type="password" name="password" class="input" tabindex="0" size="18" placeholder="<?php echo JText::_('JGLOBAL_PASSWORD') ?>" />
			</div>
		<?php else: ?>
