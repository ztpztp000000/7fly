 ...
 * @since		1.6
 */
class SpreadControllerRegistration extends UsersController
{
	/**
	...
	{var_dump('aaaa');exit;
		...
		if(JComponentHelper::getParams('com_spread')->get('allowUserRegistration') == 0) {
			$this->setRedirect(JRoute::_('index.php?option=com_spread&view=login', false));
			return false;
		}
...
var_dump($data);exit;
		...
		if ($data === false) {
			...
			$this->setRedirect(JRoute::_('index.php?option=com_spread&view=registration', false));
			return false;
		}
