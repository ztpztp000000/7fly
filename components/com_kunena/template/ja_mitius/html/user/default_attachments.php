			...
			<form action="<?php echo KunenaRoute::_('index.php?option=com_kunena') ?>" method="post" id="adminForm" name="adminForm">
				...
				<table>
					...
					<tr class="k<?php echo $usrl_class ;?>">
						...
						<td align="center" class="kcol-mid thumbnail"><?php echo $item->getThumbnailLink() ; ?></td>

						<td align="center" class="kcol-mid img-icon" >
				...
				<input class="kbutton delete-attachment-manager" type="submit" value="<?php echo JText::_('COM_KUNENA_FILES_DELETE') ?>" style="float:right;" />
			</form>
		</div>
	</div>
</div>
